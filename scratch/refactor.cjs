...
const contextContent = `import React, { createContext, useContext } from 'react';
...
fs.writeFileSync('c:\\Users\\kunwa\\Desktop\\livo_erp\\ERP-SYSTEM\\src\\context\\ERPContext.tsx', contextContent);
